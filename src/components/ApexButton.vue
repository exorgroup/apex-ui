...
<template>
  <component :is="href ? 'a' : 'button'" class="apex-btn" :href="href" :target="target"
    ...
    <span v-if="!iconOnly" class="apex-btn__txt"><slot>{{ label }}</slot></span>
    ...
    <span v-if="badge != null && badge !== ''" class="apex-btn__badge"
