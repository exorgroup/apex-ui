...
const rootStyle = computed(() => {
  ...
  if (props.radius) s['--cd-radius'] = props.radius;
  if (props.padding) s['--cd-pad'] = props.padding;
  if (props.background) s['--cd-bg'] = props.background;
  if (props.borderColor) s['--cd-border'] = props.borderColor;
  if (props.imageHeight) s['--cd-media-h'] = props.imageHeight;
  return s;
});
</script>
