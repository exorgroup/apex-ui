...
<template>
  <div v-if="ctx.indicators.value" class="apex-carousel__dots" :data-variant="variant" :data-align="ctx.indicatorPosition.value" role="tablist">
    <button v-for="i in ctx.count.value" :key="i" type="button" class="apex-carousel__dot"
